...
final class LocalizationManager: ObservableObject {
    ...
    private static let english: [String: String] = [
        ...
        "about.iosDownload": "Download Sanctuary on the App Store",
        "about.iosBody": "Take the same prayer companion with you on iPhone for novenas, saints, liturgical browsing, and reminders.",
        "about.androidDownload": "Download Sanctuary on Google Play",
        "about.androidBody": "Sanctuary for Android is on the roadmap so the same prayer companion can travel across more devices soon.",
        ...
        "about.link.appStore": "Download on the App Store",
        "about.link.googlePlaySoon": "Google Play • Coming soon",
    ...
    private static let spanish: [String: String] = [
        ...
        "about.iosDownload": "Descarga Sanctuary en App Store",
        "about.iosBody": "Lleva contigo el mismo acompañante de oración en iPhone para novenas, santos, calendario litúrgico y recordatorios.",
        "about.androidDownload": "Descarga Sanctuary en Google Play",
        "about.androidBody": "Sanctuary para Android está en la hoja de ruta para que el mismo acompañante de oración pueda llegar pronto a más dispositivos.",
        ...
        "about.link.appStore": "Descargar en App Store",
        "about.link.googlePlaySoon": "Google Play • Muy pronto",
    ...
    private static let polish: [String: String] = [
        ...
        "about.iosDownload": "Pobierz Sanctuary w App Store",
        "about.iosBody": "Zabierz tego samego towarzysza modlitwy na iPhone: nowenny, święci, kalendarz liturgiczny i przypomnienia.",
        "about.androidDownload": "Pobierz Sanctuary w Google Play",
        "about.androidBody": "Sanctuary na Androida jest w planach, aby ten sam towarzysz modlitwy mógł wkrótce trafić na kolejne urządzenia.",
        ...
        "about.link.appStore": "Pobierz w App Store",
        "about.link.googlePlaySoon": "Google Play • Wkrótce",
