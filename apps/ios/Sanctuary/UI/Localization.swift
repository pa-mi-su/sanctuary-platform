...
final class LocalizationManager: ObservableObject {
    ...
    private static let english: [String: String] = [
        ...
        "home.patronage": "Patronage",
        "home.patronageSubtitle": "Search saint patrons",
        ...
        "common.close": "Close",
        "accountRequired.title": "Continue with Sanctuary",
        "accountRequired.body": "Create a free account to save favorites and novena progress, or sign in if you already have an account.",
        "accountRequired.createAccount": "Create Account",
        "accountRequired.signIn": "Sign In",
        "accountRequired.dismiss": "Maybe Later",
        ...
        "search.intentionsTitle": "Search Intentions",
        "search.intentionsPrompt": "Search intentions (e.g. moms, healing, anxiety...)",
        "search.patronageTitle": "Search Patronage",
        "search.patronagePrompt": "Search patronages or causes",
    ...
    private static let spanish: [String: String] = [
        ...
        "home.patronage": "Patronazgo",
        "home.patronageSubtitle": "Buscar santos patronos",
        ...
        "common.close": "Cerrar",
        "accountRequired.title": "Continúa con Sanctuary",
        "accountRequired.body": "Crea una cuenta gratuita para guardar favoritos y el progreso de tus novenas, o inicia sesión si ya tienes una cuenta.",
        "accountRequired.createAccount": "Crear cuenta",
        "accountRequired.signIn": "Iniciar sesión",
        "accountRequired.dismiss": "Quizás más tarde",
        "about.title": "Sanctuary",
        ...
        "search.intentionsTitle": "Buscar intenciones",
        "search.intentionsPrompt": "Buscar intenciones (p. ej., mamás, sanación, ansiedad...)",
        "search.patronageTitle": "Buscar patronazgo",
        "search.patronagePrompt": "Buscar patronazgos o causas",
        "search.novenaType": "Novena",
    ...
    private static let polish: [String: String] = [
        ...
        "home.patronage": "Patronat",
        "home.patronageSubtitle": "Szukaj patronów",
        ...
        "accountRequired.title": "Kontynuuj z Sanctuary",
        "accountRequired.body": "Utwórz bezpłatne konto, aby zapisywać ulubione i postęp nowenn, lub zaloguj się, jeśli masz już konto.",
        "accountRequired.createAccount": "Utwórz konto",
        "accountRequired.signIn": "Zaloguj się",
        "accountRequired.dismiss": "Może później",
        "about.title": "Sanctuary",
        ...
        "search.intentionsTitle": "Szukaj intencji",
        "search.intentionsPrompt": "Szukaj intencji (np. mamy, uzdrowienie, lęk...)",
        "search.patronageTitle": "Szukaj patronatu",
        "search.patronagePrompt": "Szukaj patronatów lub spraw",
