...
final class LocalizationManager: ObservableObject {
    ...
    private static let english: [String: String] = [
        ...
        "common.close": "Close",
        "accountRequired.title": "Create an account to continue",
        "accountRequired.body": "You need a free Sanctuary account to save favorites or start a novena.",
        "accountRequired.createAccount": "Create Account",
        "accountRequired.dismiss": "Not Now",
    ...
    private static let spanish: [String: String] = [
        ...
        "common.close": "Cerrar",
        "accountRequired.title": "Crea una cuenta para continuar",
        "accountRequired.body": "Necesitas una cuenta gratuita de Sanctuary para guardar favoritos o comenzar una novena.",
        "accountRequired.createAccount": "Crear cuenta",
        "accountRequired.dismiss": "Ahora no",
        "about.title": "Sanctuary",
    ...
    private static let polish: [String: String] = [
        ...
        "accountRequired.title": "Utwórz konto, aby kontynuować",
        "accountRequired.body": "Potrzebujesz bezpłatnego konta Sanctuary, aby zapisywać ulubione lub rozpocząć nowennę.",
        "accountRequired.createAccount": "Utwórz konto",
        "accountRequired.dismiss": "Nie teraz",
        "about.title": "Sanctuary",
