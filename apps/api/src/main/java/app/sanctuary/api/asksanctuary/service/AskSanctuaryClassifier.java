...
public class AskSanctuaryClassifier {
    ...
    private static final Pattern VIOLENCE = Pattern.compile("\\b(murder|kill (him|her|them|my friend|someone)|shoot|stab|beat up|hurt someone)\\b");
    ...
    private static final Pattern IRRELEVANT = Pattern.compile("\\b(shit my pants|pooped|fart|sports score|stock price|weather forecast)\\b");
